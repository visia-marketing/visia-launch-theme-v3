    ...
    'common': {
      init: function init() {
        ...
        function initModalLinks() {
          function openModal(hash) {
            ...
            if (!modal) {
              ...
              if (target) {
                modal = target.hasAttribute('uk-modal') ? target : target.querySelector('[uk-modal]');
              }
            }
            if (!modal) return false;
            uikit__WEBPACK_IMPORTED_MODULE_2___default().modal(modal).show();
            return true;
          }
        ...
        function hoverCardsInit() {
          ...
          var hoverCards = document.querySelectorAll('.cards-style--primary');
          hoverCards.forEach(function (card) {
            // get the height of card-p ( if it exists )
            var cardP = card.querySelector('.hover-panel');
            var cardPHeight = 0;
            if (cardP) {
        ...
        function initCardCarousels() {
          var prevArrow = '<button type="button" class="cards-arrow cards-prev" aria-label="Previous slide">' + '<svg xmlns="http://www.w3.org/2000/svg" width="23" height="41" viewBox="0 0 23 41" fill="none"><path d="M21.123 1.5L2.12129 20.5018L21.123 39.5035" stroke="#062F6E" stroke-width="3" stroke-linecap="round"/></svg></button>';
          var nextArrow = '<button type="button" class="cards-arrow cards-next" aria-label="Next slide">' + '<svg xmlns="http://www.w3.org/2000/svg" width="23" height="41" viewBox="0 0 23 41" fill="none"><path d="M1.5 39.5034L20.5018 20.5017L1.5 1.4999" stroke="#062F6E" stroke-width="3" stroke-linecap="round"/></svg></button>';
          $('.cards-slick').each(function () {
            ...
            $slider.slick({
              infinite: true,
              slidesToShow: 3,
              // overridden per-instance by data-slick
              slidesToScroll: 1,
              dots: false,
              arrows: true,
              prevArrow: prevArrow,
